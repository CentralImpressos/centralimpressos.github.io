...
import { ArrowUpRight, BadgeCheck, Clock, Download, Globe, Instagram, Mail, MapPin, PenTool, Phone, Printer, Share2, Sparkles, Truck } from "lucide-react";
...
//#endregion
//#region src/assets/grafica-hero.jpg
...
function CartaoDigital() {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", { className: "absolute -left-40 -top-40 h-[38rem] w-[38rem] rounded-full bg-gradient-brand opacity-[0.18] blur-[120px] animate-aurora" }),
				/* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsx("div", { className: "absolute inset-0 opacity-[0.06] [background-image:linear-gradient(to_right,white_1px,transparent_1px),linear-gradient(to_bottom,white_1px,transparent_1px)] [background-size:56px_56px]" })
			]
		}), /* @__PURE__ */ jsxs("main", {
			...
			children: [
					...
					children: [/* @__PURE__ */ jsx("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsxs("h1", {
								...
								children: ["Sua marca impressa com ", /* @__PURE__ */ jsx("span", {
							...
							/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsxs("a", {
									...
									children: [/* @__PURE__ */ jsx(Phone, { className: "h-4 w-4" }), " Pedir orçamento"]
									...
									children: [/* @__PURE__ */ jsx(Download, { className: "h-4 w-4" }), " Salvar contato"]
								})]
							})
						]
					})]
				...
				/* @__PURE__ */ jsx("div", {
					...
					children: /* @__PURE__ */ jsx("div", {
						...
						children: [...tira, ...tira].map((item, i) => /* @__PURE__ */ jsxs("span", {
							className: "flex items-center gap-8 whitespace-nowrap text-xs font-semibold uppercase tracking-[0.2em] text-muted-foreground",
							children: [item, /* @__PURE__ */ jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-primary" })]
						}, i))
					})
				}),
				/* @__PURE__ */ jsxs("section", {
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: servicos.map((s, i) => /* @__PURE__ */ jsxs("article", {
				...
				/* @__PURE__ */ jsx("section", {
					...
					children: diferenciais.map((d, i) => /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(d.icon, { className: "mt-0.5 h-5 w-5 shrink-0 text-primary" }), /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsx("h3", {
				...
				/* @__PURE__ */ jsxs("section", {
					...
					children: [/* @__PURE__ */ jsx("h2", {
						...
						children: contatos.map((c, i) => /* @__PURE__ */ jsxs("a", {
							href: c.href,
							target: "_blank",
							rel: "noopener noreferrer",
							...
							children: [
								...
								/* @__PURE__ */ jsx(ArrowUpRight, { className: "h-4 w-4 shrink-0 text-muted-foreground transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:text-primary" })
							]
						}, c.label))
					})]
				}),
				/* @__PURE__ */ jsxs("button", {
					...
					children: [/* @__PURE__ */ jsx(Share2, { className: "h-4 w-4" }), " Compartilhar cartão"]
				}),
